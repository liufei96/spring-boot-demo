...
public class JmeterTest {
    ...
    public static final int NUMBER_THREADS = 1000;

    /** 执行结果输出的日志 */
    public static final String replayLogPath = "E:\\jmeter\\replay_result.jtl";
    ...
    private static void run() {
        ...
        String port = "8080";
        String api = "/yiyang/user";
        String request = "{\"username\":\"liufei\",\"remark\":\"wnagwu123456\"}";
